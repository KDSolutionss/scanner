...
def main(adress):
    ...
    try:
        ...
        print("невозможно разрешить доменное имя в ip-адрес")
        return
...
if __name__ == '__main__':
    ...
    print("TCP сканирование началось")
    main(adress)
    print("TCP сканирование закончилось")
    print("UDP сканирование началось")
    for port in range(1, 65535):
        sc_udp(port, adress)
    print("UDP сканирование закончилось")
